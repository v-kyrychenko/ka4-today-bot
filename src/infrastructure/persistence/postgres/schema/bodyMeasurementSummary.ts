import {bigint, bigserial, customType, date, pgTable, text, unique, varchar} from 'drizzle-orm/pg-core';
...
export const bodyMeasurementSummary = pgTable(
    ...
    (table) => [
        unique('body_measurement_summary_client_id_period_start_period_end__key').on(
            table.client_id,
            table.period_start,
            table.period_end,
            table.data_hash,
