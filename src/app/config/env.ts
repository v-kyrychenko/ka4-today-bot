...
export const EDAMAM_API_ID = getEnvVar('EDAMAM_API_ID');
export const EDAMAM_API_KEY = getEnvVar('EDAMAM_API_KEY');
export const EDAMAM_API_USER = getEnvVar('EDAMAM_API_USER');
