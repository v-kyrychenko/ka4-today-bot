...
const routeMocks = {
    ...
    setup(buildContext) {
        ...
        mockModule(buildContext, /edamamClient\.js$/, [
            ...
            '        totalWeight,',
            '        ingredients: [',
            '            ...ingredientNames.map((food) => ({food, text: food, weight: totalWeight / ingredientNames.length})),',
            '            {food: "salt", text: "salt", weight: 1},',
            '            {food: "water", text: "water", weight: 100},',
            '            {food: "olive oil", text: "olive oil", weight: 8},',
            '        ],',
            '        totalNutrients: {',
